...
function SignupForm() {
  ...
  const handleSubmit = (event) => {
    ...
    if (formData.password !== formData.password_confirmation) {
      setPasswordError(
        "Veuillez également vous assurer que le mot de passe et sa confirmation sont identiques."
      );
      setFlashMessage("");
      setDisableButton(true);
      ...
      <form onSubmit={handleSubmit}>
        ...
        {passwordError && (
          <Alert variant="danger">
            <div className="flash-message">
              <h6 /*style={{ color: 'red' }}*/>
                Le mot de passe doit comporter au moins 6 caractères, dont au
                moins une lettre majuscule, une lettre minuscule et un chiffre.{" "}
                <br /> Veuillez également vous assurer que le mot de passe et sa
                confirmation sont identiques.
              </h6>
            </div>
          </Alert>
        )}
