...
function Paid() {
  ...
  return (
    <div className='payment'>
      ...
      <h6 className='words'>Votre confiance en notre plateforme et votre soutien sont très appréciés.
        <br/>Un mail confirmation a été envoyé à l'adresse mail <span style={{color: 'green'}}>{user.email}</span> </h6>
        </div>
      )}
